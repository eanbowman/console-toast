		...
		console.log = function (message) {
			...
			setTimeout(function () {
				...
				setTimeout(function () {
					...
					document.getElementsByClassName('console--toast')[0].className = 'console--toast';
				}, 500);
			}, 5000);
